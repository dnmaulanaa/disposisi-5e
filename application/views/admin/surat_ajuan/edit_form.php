<main>
    <div class="container-fluid">
        ...
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="<?= site_url('admin/surat_masuk') ?>">Surat Masuk</a></li>
            ...
            <div class="card-body">
                <form action="<?= site_url('admin/surat_masuk/edit') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card text-dark bg-light mb-3" style="max-width: 40rem;">
                        ...
                        <div class="card-body">
                            <img src="<?= base_url('assets/photo/surat_masuk/' . $surat->image); ?>" class="card-img" width='500'>
                        </div>
                    </div>
                    <div class="mb-3">
